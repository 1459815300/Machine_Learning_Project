"""
Case:
Demonstrate the Gradient Descent method for linear regression to complete the Boston housing price prediction task.
...
# 4. Model training
# Initialize SGDRegressor (Gradient Descent-based linear regression)
# learning_rate='constant' uses a fixed learning rate
